...
export const getCompletePhase2Certificate = (
  userName: string,
  account: Account
) => {
  const title = "Phase 2 Complete Certificate";
	...
	<style type="text/css">
		...
		*{
        ...
        .background-containe{
				...
				background-image: url("https://res.cloudinary.com/unionwealthmanagement/image/upload/v1729855020/email%20images/PiksHero/Cetificates/Passed_Phase_5_kdu89u.png");
...
<body>
  ...
  margin-right: auto;">
        ...
        <div>
            <p style="text-transform: uppercase;color: #96FF72;font-weight:600;font-size:24px; padding: 3px 0px;"> Phase 2</p>
        </div>
            </center>
