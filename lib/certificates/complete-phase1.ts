...
export const getCompletePhase1Certificate = (
  userName: string,
  account: Account
) => {
  const title = "Phase 1 Complete Certificate";
  const template = `
        <!DOCTYPE html>
<html>
<head>
	...
	<style type="text/css">
		...
		*{
        ...
        .background-containe{
				...
				background-image: url("https://res.cloudinary.com/unionwealthmanagement/image/upload/v1729855021/email%20images/PiksHero/Cetificates/Passed_Phase_4_f7rnst.png");
...
<body>
	...
	<div style="margin: 0px auto; padding:5px 30px; width: 950px;);" class="background-containe">
        ...
        <div class="flex">
            ...
            <div class="top-right-title">Account sim:<br> ${
              account.accountSize
            }</div>
        </div>
  ...
  margin-right: auto;">
        ...
        <div>
            <p style="text-transform: uppercase;color: #96FF72;font-weight:600;font-size:24px; padding: 3px 0px;"> Phase 1</p>
        </div>
            </center>
