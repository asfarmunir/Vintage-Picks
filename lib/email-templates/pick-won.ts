export const getPickWonEmailTemplate = (
  name: string,
  accountNumber: string
) => {
  const PICK_WON_TITLE = "Picks Hero - Pick Won";
  const PICK_WON_TEMPLATE = `
        <!doctype html>
...
@media (max-width:441px)  { 
  ...
  <body style="word-spacing:normal;background-color:#050614;">
      ...
      <img
         height="auto" src="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1729509761/email%20images/wining%20pic/gb5frjgnpl2ik1xtiym7.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="600"
      />
      ...
      <img
         height="auto" src="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1729509983/email%20images/wining%20pic/dbpq9v1ps84uwtlnvkpq.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="600"
      />
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:16px;font-style:Poppins;font-weight:100;line-height:1.6;text-align:center;color:#ffffff;"
      >This email is to inform you that your picks worked out perfectly, amazing job!</div>
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:16px;font-style:Poppins;font-weight:100;line-height:1.6;text-align:center;color:#ffffff;"
      >The updates balance is showing on your dashboard.</div>
      ...
      <!--[if mso | IE]></td></tr></table><table align="center" border="0" cellpadding="0" cellspacing="0" class="" role="presentation" style="width:600px;" width="600" bgcolor="#050614" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><v:rect style="width:600px;" xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false"><v:fill origin="0.5, 0" position="0.5, 0" src="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1729509760/email%20images/wining%20pic/qdp1hu0ezpv52xtumeoa.png" color="#050614" type="frame" size="1,1" aspect="atmost" /><v:textbox style="mso-fit-shape-to-text:true" inset="0,0,0,0"><![endif]-->
          
      <div  style="background:#050614 url('https://res.cloudinary.com/unionwealthmanagement/image/upload/v1729509760/email%20images/wining%20pic/qdp1hu0ezpv52xtumeoa.png') right center / contain no-repeat;background-position:right center;background-repeat:no-repeat;background-size:contain;margin:0px auto;max-width:600px;">
        <div  style="line-height:0;font-size:0;">
        <table
           align="center" background="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1729509760/email%20images/wining%20pic/qdp1hu0ezpv52xtumeoa.png" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#050614 url('https://res.cloudinary.com/unionwealthmanagement/image/upload/v1729509760/email%20images/wining%20pic/qdp1hu0ezpv52xtumeoa.png') right center / contain no-repeat;background-position:right center;background-repeat:no-repeat;background-size:contain;width:100%;"
        >
          <tbody>
            <tr>
              <td
                 style="direction:ltr;font-size:0px;padding:10px 0px;text-align:center;"
              >
                <!--[if mso | IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td class="" style="vertical-align:top;width:600px;" ><![endif]-->
      ...
      >
        <tbody>
              ...
              <tr>
                <td
                   align="center" class="imagepayout" style="font-size:0px;padding:40px 60px;word-break:break-word;"
                >
