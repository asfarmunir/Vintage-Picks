export const getPickWonEmailTemplate = (
  ...
  const PICK_WON_TITLE = "Vintage Picks - Pick Won";
...
.moz-text-html .mj-column-per-20 { width:20% !important; max-width: 20%; }
  ...
  <body style="word-spacing:normal;background-color:#ffffff;">
      ...
      <!--[if mso | IE]><table align="center" border="0" cellpadding="0" cellspacing="0" class="" role="presentation" style="width:600px;" width="600" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><v:rect style="width:600px;" xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false"><v:fill origin="0, -0.5" position="0, -0.5" src="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1731614706/Vantage/Html%20Email%20Images/hero%20image/Bet_Won_env0i8.png" type="frame" size="1,1" aspect="atmost" /><v:textbox style="mso-fit-shape-to-text:true" inset="0,0,0,0"><![endif]-->
          
      <div  style="background:url('https://res.cloudinary.com/unionwealthmanagement/image/upload/v1731614706/Vantage/Html%20Email%20Images/hero%20image/Bet_Won_env0i8.png') center top / contain no-repeat;background-position:center top;background-repeat:no-repeat;background-size:contain;margin:0px auto;max-width:600px;">
        <div  style="line-height:0;font-size:0;">
        <table
           align="center" background="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1731614706/Vantage/Html%20Email%20Images/hero%20image/Bet_Won_env0i8.png" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:url('https://res.cloudinary.com/unionwealthmanagement/image/upload/v1731614706/Vantage/Html%20Email%20Images/hero%20image/Bet_Won_env0i8.png') center top / contain no-repeat;background-position:center top;background-repeat:no-repeat;background-size:contain;width:100%;"
        >
          <tbody>
            <tr>
              <td
      ...
      >
        <tbody>
              ...
              <tr>
                <td
                   align="left" style="font-size:0px;padding:20% 15% 0% 15%;word-break:break-word;"
                >
...
This email is to inform you that your picks worked out perfectly, amazing job!
      </br></br>
      ...
      <img
         height="auto" src="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1731620791/Vantage/Html%20Email%20Images/hero%20image/Login_to_dashboard_urqesl.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="160"
      />
