export const getPickLossEmailTemplate = (
  name: string,
...
@media (max-width:441px)  { 
  ...
  <body style="word-spacing:normal;background-color:#050614;">
      ...
      <img
         height="auto" src="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1729510821/email%20images/lost%20bet/l12tebjmvf72x54glyg0.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="600"
      />
      ...
      <img
         height="auto" src="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1729510820/email%20images/lost%20bet/kfmqc5ohzxslao1gepas.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="600"
      />
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:16px;font-style:Poppins;font-weight:100;line-height:1.6;text-align:center;color:#ffffff;"
      >This email is to inform you that your picks lost unfortunately.. Don’t worry, the next is around the corner!</div>
      ...
      <!--[if mso | IE]></td></tr></table><table align="center" border="0" cellpadding="0" cellspacing="0" class="" role="presentation" style="width:600px;" width="600" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><v:rect style="width:600px;" xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false"><v:fill origin="0.5, 0" position="0.5, 0" src="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1729510944/email%20images/lost%20bet/bbfpkfvvolilh3ble0ur.png" type="frame" size="1,1" aspect="atmost" /><v:textbox style="mso-fit-shape-to-text:true" inset="0,0,0,0"><![endif]-->
          
      <div  style="background:url('https://res.cloudinary.com/unionwealthmanagement/image/upload/v1729510944/email%20images/lost%20bet/bbfpkfvvolilh3ble0ur.png') right center / contain no-repeat;background-position:right center;background-repeat:no-repeat;background-size:contain;margin:0px auto;max-width:600px;">
        <div  style="line-height:0;font-size:0;">
        <table
           align="center" background="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1729510944/email%20images/lost%20bet/bbfpkfvvolilh3ble0ur.png" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:url('https://res.cloudinary.com/unionwealthmanagement/image/upload/v1729510944/email%20images/lost%20bet/bbfpkfvvolilh3ble0ur.png') right center / contain no-repeat;background-position:right center;background-repeat:no-repeat;background-size:contain;width:100%;"
        >
          <tbody>
            <tr>
              <td
      ...
      >
        <tbody>
              ...
              <tr>
                <td
                   align="center" style="font-size:0px;padding:10px 60px 0px 60px;word-break:break-word;"
                >
                  
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:16px;font-style:Poppins;font-weight:100;line-height:1.6;text-align:center;color:#ffffff;"
      >The updates balance is showing on yourThe updates balance is showing on your dashboard.</div>
              ...
              <tr>
                <td
                   align="center" class="imagepayout" style="font-size:0px;padding:20px 60px;word-break:break-word;"
                >
      ...
      <img
         height="auto" src="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1729508709/email%20images/Payout%20Reminder/uzo5zm1lokqs8lgft7gd.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="230"
      />
