...
@media (max-width:441px)  { 
  ...
  <body style="word-spacing:normal;background-color:#050614;">
      ...
      <!--[if mso | IE]></td></tr></table><table align="center" border="0" cellpadding="0" cellspacing="0" class="img-container-outlook phase1img-outlook" role="presentation" style="width:600px;" width="600" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
    
      
      <div  class="img-container phase1img" style="margin:0px auto;max-width:600px;">
      ...
      >
        <tbody>
              ...
              <tr>
                <td
                   align="center" class="congrat-title" style="font-size:0px;padding:10px 25px;padding-bottom:35px;word-break:break-word;"
                >
      ...
      ><span style="background: rgba(255, 255, 255, 0.2);padding:10px; border-radius:5px;"> Congratulations</span></div>
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:18px;font-style:Poppins;font-weight:800;line-height:1.4;text-align:center;color:#ffffff;"
      >Your account ${accountNumber}</br> has passed the <span style="color:#53FC18"> Phase 1 objectives.</span></div>
