export const getContractEmailTemplate = (name: string) => {
    const title = 'Contract Awaits you';
    const template = (`
        <!doctype html>
...
@media (max-width:441px)  { 
  ...
  <body style="word-spacing:normal;background-color:#050614;">
      ...
      <img
         height="auto" src="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1729502493/email%20images/Contract%20Awaiting/hlyrkmbtsvg4oyhpe8mk.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="600"
      />
      ...
      <img
         height="auto" src="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1729502492/email%20images/Contract%20Awaiting/sxq0lbajyl9iwlh8babd.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="600"
      />
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:16px;font-style:Poppins;font-weight:100;line-height:1.6;text-align:center;color:#ffffff;"
      >A contract is awaiting for you in your dashboard, please review, and sign it.</div>
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:16px;font-style:Poppins;font-weight:100;line-height:1.6;text-align:center;color:#ffffff;"
      >Once signed, you will receive your live account!</div>
      ...
      >
        <tbody>
              ...
              <tr>
                <td
                   align="center" class="congrat-title" style="font-size:0px;padding:10px 25px;padding-bottom:5px;word-break:break-word;"
                >
      ...
      ><span style="background: rgba(255, 255, 255, 0.2);padding:10px; border-radius:5px;"> you did a great job!</span></div>
      ...
      <!--[if mso | IE]></td></tr></table><table align="center" border="0" cellpadding="0" cellspacing="0" class="" role="presentation" style="width:600px;" width="600" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><v:rect style="width:600px;" xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false"><v:fill origin="-0.5, 0" position="-0.5, 0" src="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1729502493/email%20images/Contract%20Awaiting/nhp7sqcbnahqibkznmv3.png" type="frame" size="1,1" aspect="atmost" /><v:textbox style="mso-fit-shape-to-text:true" inset="0,0,0,0"><![endif]-->
          
      <div  style="background:url('https://res.cloudinary.com/unionwealthmanagement/image/upload/v1729502493/email%20images/Contract%20Awaiting/nhp7sqcbnahqibkznmv3.png') left center / contain no-repeat;background-position:left center;background-repeat:no-repeat;background-size:contain;margin:0px auto;max-width:600px;">
        <div  style="line-height:0;font-size:0;">
        <table
           align="center" background="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1729502493/email%20images/Contract%20Awaiting/nhp7sqcbnahqibkznmv3.png" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:url('https://res.cloudinary.com/unionwealthmanagement/image/upload/v1729502493/email%20images/Contract%20Awaiting/nhp7sqcbnahqibkznmv3.png') left center / contain no-repeat;background-position:left center;background-repeat:no-repeat;background-size:contain;width:100%;"
        >
          <tbody>
            <tr>
              <td
      ...
      >
        <tbody>
              ...
              <tr>
                <td
                   align="center" style="font-size:0px;padding:60px;word-break:break-word;"
                >
    ...
    <a href="https://app.pickshero.io/settings?tab=agreements">
        <img
        height="auto" src="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1729506303/email%20images/Contract%20Awaiting/lvsazdgxcraaahbphtg5.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="200"
        />
    </a>
