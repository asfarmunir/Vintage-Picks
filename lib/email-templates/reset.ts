...
@media (max-width:441px)  { 
  ...
  <body style="word-spacing:normal;background-color:#050614;">
      ...
      <img
         height="auto" src="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1729507215/email%20images/PasswordReset/oy4swwkycbhrmurg4lky.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="600"
      />
      ...
      <img
         height="auto" src="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1729507214/email%20images/PasswordReset/fwi7tj1zt7pnf0m9wbsl.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="600"
      />
      ...
      <!--[if mso | IE]></td></tr></table><table align="center" border="0" cellpadding="0" cellspacing="0" class="" role="presentation" style="width:600px;" width="600" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><v:rect style="width:600px;" xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false"><v:fill origin="0.5, 0" position="0.5, 0" src="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1729507215/email%20images/PasswordReset/pfykcv3gjzxupjyyjdcl.png" type="frame" size="1,1" aspect="atmost" /><v:textbox style="mso-fit-shape-to-text:true" inset="0,0,0,0"><![endif]-->
          
      <div  style="background:url('https://res.cloudinary.com/unionwealthmanagement/image/upload/v1729507215/email%20images/PasswordReset/pfykcv3gjzxupjyyjdcl.png') right center / contain no-repeat;background-position:right center;background-repeat:no-repeat;background-size:contain;margin:0px auto;max-width:600px;">
        <div  style="line-height:0;font-size:0;">
        <table
           align="center" background="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1729507215/email%20images/PasswordReset/pfykcv3gjzxupjyyjdcl.png" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:url('https://res.cloudinary.com/unionwealthmanagement/image/upload/v1729507215/email%20images/PasswordReset/pfykcv3gjzxupjyyjdcl.png') right center / contain no-repeat;background-position:right center;background-repeat:no-repeat;background-size:contain;width:100%;"
        >
          <tbody>
            <tr>
              <td
      ...
      >Hey If you’ve lost your <span style="color:#53FC18;">password</span> or wish to reset it,</br> use the link below to get started.</div>
              ...
              <tr>
                <td
                   align="center" style="font-size:0px;padding:70px 10px 10px 10px;word-break:break-word;"
                >
        ...
        <tbody>
          <tr>
            <td  style="width:200px;">
              <a href="${resetLink}">
      <img
         height="auto" src="https://res.cloudinary.com/unionwealthmanagement/image/upload/v1729507475/email%20images/PasswordReset/ufub8l3xpb2y68potky9.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="200"
      />
    </a>
            </td>
          </tr>
      ...
      >
        <tbody>
              ...
              <tr>
                <td
                   align="center" style="font-size:0px;padding:10px 20px 0px 20px;word-break:break-word;"
                >
                  
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:16px;font-style:Poppins;font-weight:100;line-height:1.6;text-align:center;color:#ffffff;"
      >HIf you did not wish to reset your password, you can safely
