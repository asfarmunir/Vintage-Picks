  ...
  return (
    <>
      ...
      <div className=" w-full p-2 md:p-3 rounded-2xl bg-vintage-50 space-y-2">
        <div className="flex items-center justify-between bg-white p-4 md:p-6 rounded-2xl">
          <div className="">
          ...
          <div className="flex items-center  gap-3">
            <button
              className="text-white  font-semibold hover:border hover:border-primary-200 uppercase text-[8px] text-nowrap md:text-base 2xl:text-base bg-vintage-50 px-8 py-3.5 rounded-full inline-flex items-center gap-3"
      ...
      <div className="w-full flex text-white gap-4   max-h-full overflow-auto">
        <div className="w-full  h-full shadow-inner shadow-gray-800 flex flex-col gap-7 bg-[#181926] p-4 md:p-6 rounded-xl">
