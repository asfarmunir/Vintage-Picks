...
const CheckoutPayment: React.FC<CheckoutPaymentProps> = ({
  ...
  //       console.log("Invoice created successfully. Data:", data);
  ...
  //       const newTab = window.open(data.hosted_url, "_blank");

  //       // Show the toast after opening the tab
  ...
  async function onSubmit(values: any) {
    ...
    if (actionType === "crypto") {
      ...
      try {
        ...
        if (res?.hosted_url) {
          newTab.location.href = res.hosted_url;
          toast.dismiss();
          toast.success("Invoice created successfully");
