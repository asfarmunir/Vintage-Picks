    ...
    <>
      <Table>
        ...
        <TableHeader className=" bg-[#333547] text-[#848BAC] border-none">
          <TableRow className=" border-none">
            ...
            <TableHead className="uppercase font-bold text-start"></TableHead>
          </TableRow>
        </TableHeader>
        <TableBody className=" ">
            ...
            <TableRow key={game.id}>
              ...
              <TableCell className=" w-full py-5 border-b border-gray-700 ">
                <button
                  ...
                  className=" bg-primary-50/20 text-primary-50 font-bold px-5 text-nowrap py-3 rounded-md"
                >
                  More Picks
                </button>
              </TableCell>
      ...
      <div className="flex items-center justify-between p-5">
        ...
        <div className="flex gap-2 items-center">
          <button
            className={`text-2xl
            ${startIndex === 0 ? "text-[#848BAC]" : "text-white"}
            `}
            onClick={goPrev}
          >
            <TiArrowLeft />
